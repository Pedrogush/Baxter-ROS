...
def main():
	rospy.init_node('move_left_hand')
        Hand_Shaker = hand_shaker()
	Hand_Shaker.get_info() 
	while Hand_Shaker.loopvar<1:
	      Hand_Shaker.listener()    
	      for posmarker in Hand_Shaker.posmarkers:
                  limb_joints = Hand_Shaker.positions[Hand_Shaker.posmarkers[posmarker]]
		  Hand_Shaker.left.move_to_joint_positions(limb_joints)
#		  Hand_Shaker.F.write(repr(Hand_Shaker.posmarkers[posmarker]) + '\n')
#		  Hand_Shaker.F.write(repr(Hand_Shaker.positions[Hand_Shaker.posmarkers[posmarker]]) + '\n')
	      Hand_Shaker.loopvar=2
